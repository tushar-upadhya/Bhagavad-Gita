    ...
    <div className="container p-4 mx-auto text-base sm:p-6 lg:p-8 sm:text-lg md:text-xl lg:text-2xl xl:text-xl">
      ...
      <div className="leading-10 text-center">
        ...
        <p className="mt-10 mb-6">
          ...
          <span className="font-semibold text-[#cca14ac6]">Lord Krishna</span>{" "}
          on the battlefield of Kurukshetra. As both armies stand ready for the
          battle, the mighty warrior Arjuna, on observing the warriors on both
          sides becomes overwhelmed with grief and compassion due to the fear of
          losing his relatives and friends and the consequent sins attributed to
          killing his own relatives. So, he surrenders to{" "}
          <span className="font-semibold text-[#cca14ac6]">Lord Krishna</span>,
          seeking a solution. Thus, follows the wisdom of the Bhagavad Gita.
          Over 18 chapters, Gita packs an intense analysis of life, emotions and
          ambitions, discussion of various types of yoga, including Jnana,{" "}
          <span className="font-semibold text-[#cca14ac6]">
            Bhakti, Karma and Raja
          </span>
